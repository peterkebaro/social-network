...
export class Reloj extends Component <{}, relojState> {
    ...
    componentDidMount() {               //Ejecutará cada segundo el método tick para mostrar la hora cada segundo en el DOM
    ...
    render() {
    	...
    	return (
            <div className="contenedor-reloj">
                ...
                <h2 className="hora">{this.state.date.toLocaleTimeString()}.</h2>
            </div>
      	)
    }
